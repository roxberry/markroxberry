...
if ( ! is_admin() ) {
  ...
  wp_enqueue_script( 'jquery', get_template_directory_uri() . "/js/jquery-1.4.4.min.js", null, '1.4.4', true );
  wp_enqueue_script( 'md5', get_template_directory_uri() . "/js/md5.js", null, null, true );
  wp_enqueue_script( 'prettyjs', get_template_directory_uri() . "/js/pretty.js", null, null, true );
  wp_enqueue_script( 'jquery.tools', "http://cdn.jquerytools.org/1.2.5/full/jquery.tools.min.js", array('jquery'), null, true );
  wp_enqueue_script( 'showcase_scripts', get_template_directory_uri() . "/js/scripts.js", array('jquery', 'jquery.tools'), null, true );
  /* if ( $is_IE ) {
   wp_enqueue_script( 'DD_belatedPNG', get_template_directory_uri() . "/js/DD_belatedPNG.js", false, null, true ); 
  } */
}
	...
	$output .= <<<EOT
		<form action="$action" method="post" id="contact-form" class="row">
			...
			<div class="grid_8 column">
                <input type="submit" class="metro-button" name="sc_contact_send" value="Send">
			</div>
		</form>
EOT;
